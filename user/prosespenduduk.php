...
if (move_uploaded_file($tmp_file, $path)) {
    ...
    $query = "INSERT INTO daftar_warga (id_user,nama, jenis_kelamin, alamat, nik, no_telp, email, gambar) VALUES ('$id _user','$nama', '$jenis_kelamin', '$alamat', '$nik', '$no_telp', '$email', '$nama_file')";
