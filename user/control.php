...
$tambahEvent = fn ($id_user, $judul, $gambar, $tanggal, $keterangan, $status) => mysqli_query($conn, "INSERT INTO event VALUES('','$id_user','$judul','$gambar','$tanggal','$keterangan','$status')");
