            ...
            <table class="table py-3" id="dataTable" style="min-width: 1000px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=artikel&&id_setujui=<?php echo $data['id_artikel'] ?>"
                                class="btn btn-success btn-sm" data-bs-toggle="modal"
                                data-bs-target="#setujui<?php echo $data['id_artikel'] ?>">Setujui</a>
                            <div class=" modal fade" id="setujui<?php echo $data['id_artikel'] ?>" tabindex="-1"
                            ...
                            <a href="" class="btn btn-warning text-light btn-sm" data-bs-toggle="modal"
                                data-bs-target="#detail<?php echo $data['id_artikel'] ?>">Detail</a>


                            <div class=" modal fade" id="detail<?php echo $data['id_artikel'] ?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <a class="btn btn-danger  btn-sm" data-bs-toggle="modal"
                                data-bs-target="#hapus<?php echo $data['id_artikel'] ?>">Hapus</a>
                            <div class=" modal fade" id="hapus<?php echo $data['id_artikel'] ?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <a href="?page=artikel&&id=<?php echo $data['id_artikel'] ?>"
