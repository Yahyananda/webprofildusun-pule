        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <img src="https://cdn-icons-png.flaticon.com/512/149/149071.png"
                    class="img-thumnail w-100 p-2 bg-secondary" alt="">
                <?php
                } else {
                ?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="number" value="<?php echo $datasiswa['angkatan'] ?>"
                                class="form-control p-2 mt-2 mb-3" disabled>

                        </div>
                        <div class="col-lg-6">
                            <label for="">NIS</label>
                            <input type="number" name="nis" value="<?php echo $datasiswa['nis'] ?>"
                                class="form-control p-2 mt-2 mb-3" disabled>
                            <label for="">NISN</label>
                            <input type="number" name="nisn" value="<?php echo $datasiswa['nisn'] ?>"
                                class="form-control p-2 mt-2 mb-3" disabled>
                            <label for="">No Wa</label>
                            <input type="number" name="no_wa" value="<?php echo $datasiswa['no_wa'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                            <label for="">Email</label>
                            <input type="email" name="email" value="<?php echo $datasiswa['email'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                        </div>
                        <div class="col">
                            <button class="btn btn-warning text-light p-2 px-4" name="perbarui">Perbarui</button>
                            <a class="btn btn-secondary text-light p-2 px-4" data-bs-toggle="modal"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="username" value="<?php echo $user['username'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                            <label for="">NIP</label>
                            <input type="number" name="nip" value="<?php echo $dataguru['nip'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                        </div>
                        <div class="col-lg-6">
                            <label for="">Mata Pelajaran</label>
                            <input type="text" name="mapel" value="<?php echo $dataguru['mapel'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                            <label for="">No Wa</label>
                            <input type="number" name="no_wa" value="<?php echo $dataguru['no_wa'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                            <label for="">Email</label>
                            <input type="email" name="email" value="<?php echo $dataguru['email'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                            <label for="">Alamat</label>
                            <input type="text" name="alamat" value="<?php echo $dataguru['alamat'] ?>"
                                class="form-control p-2 mt-2 mb-3">
                        </div>
                        <div class="col">
