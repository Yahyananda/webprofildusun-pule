                                                        ...
                                                        ?>
                                                            <div class="d-flex mt-3 <?php if ($data['id_komentar'] == $komentar['id_komentar']) {
                                                                ...
                                                                <div class="me-3">
                                                                    ...
                                                                    if ($komentar['foto'] != '') {
                                                                    ?>
                                                                        <div class="img-komentar" style="background-image: url('../img/user/<?php echo $komentar['foto'] ?>');">
                                                                        </div>
                                                                    <?php } else { ?>
                                                                        <div class="img-komentar" style="background-image: url('https://cdn-icons-png.flaticon.com/512/149/149071.png');">
                                                                        </div>
